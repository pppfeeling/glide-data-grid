 ...
 */
export declare function getGroupName(group: string | readonly string[] | undefined, level?: number): string;
/**
 ...
 */
export declare function getGroupAtLevel(group: string | readonly string[] | undefined, level: number, totalLevels: number): string | undefined;
export declare function isGroupEqual(left: string | readonly string[] | undefined, right: string | readonly string[] | undefined): boolean;
/**
 ...
 */
export declare function isGroupEqualAtLevel(left: string | readonly string[] | undefined, right: string | readonly string[] | undefined, level: number, totalLevels: number): boolean;
...
export declare function getRowIndexForY(targetY: number, height: number, hasGroups: boolean, headerHeight: number, groupHeaderHeight: number, rows: number, rowHeight: number | ((index: number) => number), cellYOffset: number, translateY: number, freezeTrailingRows: number, groupLevels?: number, groupHeaderHeights?: readonly number[]): number | undefined;
/** @category Drawing */
