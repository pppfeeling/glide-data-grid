...
export const drilldownCellRenderer = {
  ...
  measure: (ctx, cell, theme) => cell.data.reduce((acc, data) => ctx.measureText(data.text).width + acc + theme.bubblePadding * 2 + theme.bubbleMargin + (data.img !== undefined ? 18 : 0), 0) + 2 * theme.cellHorizontalPadding - 4,
