...
function resolveEventTarget(target) {
  ...
  if ("current" in target && !("addEventListener" in target)) {
...
class SpriteManager {
  ...
  updateIcons(headerIcons) {
    const newIcons = headerIcons !== null && headerIcons !== void 0 ? headerIcons : {};
  ...
  if ($2[20] !== cellXOffset || $2[21] !== cellYOffset || $2[22] !== enableGroups || $2[23] !== fillHandle || $2[24] !== freezeTrailingRows || $2[25] !== getBoundsForItem || $2[26] !== groupHeaderHeight || $2[27] !== groupHeaderHeights || $2[28] !== groupLevels || $2[29] !== headerHeight || $2[30] !== height || $2[31] !== mappedColumns || $2[32] !== rowHeight || $2[33] !== rows || $2[34] !== selection || $2[35] !== totalHeaderHeight || $2[36] !== translateX || $2[37] !== translateY || $2[38] !== width) {
    t2 = (canvas_0, posX, posY, ev) => {
      ...
      if (col_0 === -1 || y2 < 0 || x2 < 0 || row_0 === void 0 || x2 > width || y2 > height) {
        ...
        if (horizontal === 0) {
          innerHorizontal = col_0 === -1 ? OutOfBoundsRegionAxis.EndPadding : OutOfBoundsRegionAxis.Center;
        }
        if (vertical === 0) {
          innerVertical = row_0 === void 0 ? OutOfBoundsRegionAxis.EndPadding : OutOfBoundsRegionAxis.Center;
        }
        let isEdge = false;
        if (col_0 === -1 && row_0 === -1) {
          const b2 = getBoundsForItem(canvas_0, mappedColumns.length - 1, -1);
          assert(b2 !== void 0);
        ...
        if (row_0 <= -1) {
          ...
          const isEdge_1 = bounds_0 !== void 0 && bounds_0.x + bounds_0.width - posX < 5;
...
function drawHighlightRings(ctx, width, height, cellXOffset, cellYOffset, translateX, translateY, mappedColumns, freezeColumns, headerHeight, totalGroupHeaderHeight, rowHeight, freezeTrailingRows, rows, allHighlightRegions, theme, groupLevels, groupHeaderHeights) {
  ...
  const drawRects = highlightRegions.map((h) => {
    ...
    return splitRectIntoRegions(r, splitIndicies, width, height, splitLocations).map((arg) => {
      ...
      if (h.clipLeftPx !== void 0 && h.clipLeftPx > 0) {
...
function drawGrid(arg, lastArg) {
  ...
  if (damage !== void 0) {
    ...
    if (damageInView) {
      doDamage(targetCtx);
      drawHighlightRings(targetCtx, width, height, cellXOffset, cellYOffset, translateX, translateY, mappedColumns, freezeColumns, headerHeight, totalGroupHeaderHeight, rowHeight, freezeTrailingRows, rows, highlightRegions, theme, groupLevels, groupHeaderHeights);
      if (drawFocus) {
      ...
      if (mainCtx !== null) {
        ...
        doDamage(mainCtx);
        drawHighlightRings(mainCtx, width, height, cellXOffset, cellYOffset, translateX, translateY, mappedColumns, freezeColumns, headerHeight, totalGroupHeaderHeight, rowHeight, freezeTrailingRows, rows, highlightRegions, theme, groupLevels, groupHeaderHeights);
        if (drawFocus) {
          drawFillHandle(mainCtx, width, height, cellYOffset, translateX, translateY, effectiveCols, mappedColumns, theme, totalHeaderHeight, selection, getRowHeight, getCellContent, freezeTrailingRows, hasAppendRow, fillHandle, rows);
        }
        mainCtx.restore();
      }
...
function useGridPointerEvents(args) {
    ...
    t1 = (canvas, col, clientX, clientY) => {
      ...
      if (!isDragging && !isResizing && !(hoveredOnEdge !== null && hoveredOnEdge !== void 0 ? hoveredOnEdge : false)) {
        ...
        if (header.hasMenu === true && headerLayout.menuBounds !== void 0 && pointInRect(headerLayout.menuBounds, clientX, clientY)) {
          ...
          if (header.indicatorIcon !== void 0 && headerLayout.indicatorIconBounds !== void 0 && pointInRect(headerLayout.indicatorIconBounds, clientX, clientY)) {
            return {
              area: "indicator",
  ...
  if ($2[9] !== canvasRef || $2[10] !== eventTargetRef || $2[11] !== getMouseArgsForPosition || $2[12] !== groupHeaderActionForEvent || $2[13] !== isDraggable || $2[14] !== isOverHeaderElement || $2[15] !== lastWasTouchRef || $2[16] !== onMouseDown || $2[17] !== setLastWasTouch) {
    t2 = (ev) => {
      ...
      if (canvas_0 === null || ev.target !== canvas_0 && ev.target !== eventTarget) {
        return;
      }
      mouseDown.current = true;
      const clientX_0 = ev.clientX;
      const clientY_0 = ev.clientY;
      if (ev.target === eventTarget && eventTarget !== null) {
        const bounds_0 = eventTarget.getBoundingClientRect();
        if (clientX_0 > bounds_0.right || clientY_0 > bounds_0.bottom) {
          return;
        }
      }
      const mouseArgs = getMouseArgsForPosition(canvas_0, clientX_0, clientY_0, ev);
      ...
      if (mouseArgs.kind === headerKind && isOverHeaderElement(canvas_0, mouseArgs.location[0], clientX_0, clientY_0) !== void 0) {
        return;
      } else {
      ...
      onMouseDown === null || onMouseDown === void 0 || onMouseDown(mouseArgs);
      if (!mouseArgs.isTouch && isDraggable !== true && isDraggable !== mouseArgs.kind && mouseArgs.button < 3 && mouseArgs.button !== 1) {
        ev.preventDefault();
      }
    };
    $2[9] = canvasRef;
  ...
  if ($2[19] !== canvasRef || $2[20] !== eventTargetRef || $2[21] !== getMouseArgsForPosition || $2[22] !== groupHeaderActionForEvent || $2[23] !== isOverHeaderElement || $2[24] !== lastWasTouchRef || $2[25] !== onMouseUp || $2[26] !== setLastWasTouch) {
    t3 = (ev_0) => {
      ...
      if (onMouseUp === void 0 || canvas_1 === null) {
        return;
      }
      const eventTarget_0 = eventTargetRef === null || eventTargetRef === void 0 ? void 0 : eventTargetRef.current;
      const isOutside = ev_0.target !== canvas_1 && ev_0.target !== eventTarget_0;
      const clientX_1 = ev_0.clientX;
      const clientY_1 = ev_0.clientY;
      const canCancel = ev_0.pointerType === "mouse" ? ev_0.button < 3 : true;
      let mouseArgs_0 = getMouseArgsForPosition(canvas_1, clientX_1, clientY_1, ev_0);
      if (mouseArgs_0.isTouch && downTime.current !== 0 && Date.now() - downTime.current > 500) {
        mouseArgs_0 = {
          ...mouseArgs_0,
          isLongTouch: true
        };
      }
      if (lastUpTimeValue !== 0 && Date.now() - lastUpTimeValue < (mouseArgs_0.isTouch ? 1e3 : 500)) {
        mouseArgs_0 = {
          ...mouseArgs_0,
          isDoubleClick: true
        };
      }
      if (lastWasTouchRef.current !== mouseArgs_0.isTouch) {
        setLastWasTouch(mouseArgs_0.isTouch);
      }
      if (!isOutside && ev_0.cancelable && canCancel) {
        ev_0.preventDefault();
      }
      const [col_0] = mouseArgs_0.location;
      const headerBounds_0 = isOverHeaderElement(canvas_1, col_0, clientX_1, clientY_1);
      if (mouseArgs_0.kind === headerKind && headerBounds_0 !== void 0) {
        var _downPosition$current, _downPosition$current2;
        if (mouseArgs_0.button !== 0 || ((_downPosition$current = downPosition.current) === null || _downPosition$current === void 0 ? void 0 : _downPosition$current[0]) !== col_0 || ((_downPosition$current2 = downPosition.current) === null || _downPosition$current2 === void 0 ? void 0 : _downPosition$current2[1]) !== -1) {
          onMouseUp(mouseArgs_0, true);
        }
        return;
      } else {
        if (mouseArgs_0.kind === groupHeaderKind) {
          const action_0 = groupHeaderActionForEvent(mouseArgs_0.group, mouseArgs_0.bounds, mouseArgs_0.localEventX, mouseArgs_0.localEventY);
          if (action_0 !== void 0) {
            if (mouseArgs_0.button === 0) {
              action_0.onClick(mouseArgs_0);
            }
            return;
          }
        }
  ...
  if ($2[28] !== canvasRef || $2[29] !== eventTargetRef || $2[30] !== getMouseArgsForPosition || $2[31] !== isOverHeaderElement || $2[32] !== lastWasTouchRef || $2[33] !== onHeaderIndicatorClick || $2[34] !== onHeaderMenuClick || $2[35] !== setLastWasTouch) {
    t4 = (ev_1) => {
      ...
      const isOutside_0 = ev_1.target !== canvas_2 && ev_1.target !== eventTarget_1;
      let clientX_2;
      let clientY_2;
      let canCancel_0 = true;
      if (ev_1 instanceof MouseEvent) {
        clientX_2 = ev_1.clientX;
        clientY_2 = ev_1.clientY;
        canCancel_0 = ev_1.button < 3;
      } else {
        clientX_2 = ev_1.changedTouches[0].clientX;
        clientY_2 = ev_1.changedTouches[0].clientY;
      }
      const mouseArgs_1 = getMouseArgsForPosition(canvas_2, clientX_2, clientY_2, ev_1);
      if (lastWasTouchRef.current !== mouseArgs_1.isTouch) {
        setLastWasTouch(mouseArgs_1.isTouch);
      }
      if (!isOutside_0 && ev_1.cancelable && canCancel_0) {
        ev_1.preventDefault();
      }
      const [col_1] = mouseArgs_1.location;
      if (mouseArgs_1.kind === headerKind) {
        var _downPosition$current3, _downPosition$current4;
        const headerBounds_1 = isOverHeaderElement(canvas_2, col_1, clientX_2, clientY_2);
        if (headerBounds_1 !== void 0 && mouseArgs_1.button === 0 && ((_downPosition$current3 = downPosition.current) === null || _downPosition$current3 === void 0 ? void 0 : _downPosition$current3[0]) === col_1 && ((_downPosition$current4 = downPosition.current) === null || _downPosition$current4 === void 0 ? void 0 : _downPosition$current4[1]) === -1) {
          if (headerBounds_1.area === "menu") {
            onHeaderMenuClick === null || onHeaderMenuClick === void 0 || onHeaderMenuClick(col_1, headerBounds_1.bounds);
          } else {
            if (headerBounds_1.area === "indicator") {
              onHeaderIndicatorClick === null || onHeaderIndicatorClick === void 0 || onHeaderIndicatorClick(col_1, headerBounds_1.bounds);
            }
          }
        }
      }
  ...
  if ($2[37] !== canvasRef || $2[38] !== eventTargetRef || $2[39] !== getMouseArgsForPosition || $2[40] !== onContextMenu) {
    t5 = (ev_2) => {
      ...
      if (canvas_3 === null || ev_2.target !== canvas_3 && ev_2.target !== eventTarget_2 || onContextMenu === void 0) {
        return;
      }
      const mouseArgs_2 = getMouseArgsForPosition(canvas_3, ev_2.clientX, ev_2.clientY, ev_2);
      onContextMenu(mouseArgs_2, () => {
        if (ev_2.cancelable) {
          ev_2.preventDefault();
        }
      });
  ...
  if ($2[44] !== allowResize || $2[45] !== canvasRef || $2[46] !== damageInternal || $2[47] !== eventTargetRef || $2[48] !== firstColAccessible || $2[49] !== getCellContent || $2[50] !== getCellRenderer || $2[51] !== getMouseArgsForPosition || $2[52] !== hoverInfoRef || $2[53] !== maybeSetHoveredInfo || $2[54] !== onItemHovered || $2[55] !== onMouseMove || $2[56] !== onMouseMoveRaw || $2[57] !== setDrawCursorOverride || $2[58] !== setHoveredOnEdge || $2[59] !== setOverFill) {
    t7 = (ev_3) => {
      ...
      const isIndirect = ev_3.target !== canvas_4 && ev_3.target !== eventTarget_3;
      const mouseArgs_3 = getMouseArgsForPosition(canvas_4, ev_3.clientX, ev_3.clientY, ev_3);
      ...
      if (!mouseEventArgsAreEqual(mouseArgs_3, hoveredRef.current)) {
        ...
        maybeSetHoveredInfo(mouseArgs_3.kind === outOfBoundsKind ? void 0 : [mouseArgs_3.location, [mouseArgs_3.localEventX, mouseArgs_3.localEventY]], true);
        hoveredRef.current = mouseArgs_3;
      } else {
        if (mouseArgs_3.kind === "cell" || mouseArgs_3.kind === headerKind || mouseArgs_3.kind === groupHeaderKind) {
          let needsDamageCell;
          let needsHoverPosition = true;
          if (mouseArgs_3.kind === "cell") {
            var _getCellRenderer;
            const toCheck = getCellContent(mouseArgs_3.location);
          ...
          const newInfo = [mouseArgs_3.location, [mouseArgs_3.localEventX, mouseArgs_3.localEventY]];
          maybeSetHoveredInfo(newInfo, needsHoverPosition);
          hoverInfoRef.current = newInfo;
          if (needsDamageCell) {
            damageInternal(new CellSet([mouseArgs_3.location]));
          }
        }
      }
      const notRowMarkerCol = mouseArgs_3.location[0] >= (firstColAccessible ? 0 : 1);
      setHoveredOnEdge(mouseArgs_3.kind === headerKind && mouseArgs_3.isEdge && notRowMarkerCol && allowResize === true);
      setOverFill(mouseArgs_3.kind === "cell" && mouseArgs_3.isFillHandle);
...
function useGridDragAndDrop(args) {
          ...
          if (row !== void 0) {
            ...
            if (ctx !== null) {
              ...
              if (row === -1) {
                ...
                ctx.fillRect(0, 0, offscreen.width, offscreen.height);
                drawCell(ctx, getCellContent([col, row]), 0, row, false, false, 0, 0, boundsForDragTarget.width, boundsForDragTarget.height, false, theme, theme.bgCell, imageLoader, spriteManager, 1, void 0, false, 0, void 0, void 0, void 0, renderStateProvider, getCellRenderer, _temp$9, 0);
              }
            }
  ...
  if ($2[15] !== canvasRef || $2[16] !== firstColAccessible || $2[17] !== getMouseArgsForPosition || $2[18] !== onDragOverCell || $2[19] !== onDrop) {
    t1 = (event_0) => {
      ...
      if (canvas_0 === null || onDragOverCell === void 0) {
        return;
      }
      const mouseArgs_0 = getMouseArgsForPosition(canvas_0, event_0.clientX, event_0.clientY);
      const [rawCol, row_0] = mouseArgs_0.location;
      const col_0 = rawCol - (firstColAccessible ? 0 : 1);
      ...
      if (activeCol !== col_0 || activeRow !== row_0) {
        activeDropTarget.current = [col_0, row_0];
  ...
  if ($2[23] !== canvasRef || $2[24] !== firstColAccessible || $2[25] !== getMouseArgsForPosition || $2[26] !== onDrop) {
    t3 = (event_1) => {
      ...
      const mouseArgs_1 = getMouseArgsForPosition(canvas_1, event_1.clientX, event_1.clientY);
      const [rawCol_0, row_1] = mouseArgs_1.location;
...
function useGridFocusAndAccessibility(args) {
  ...
  if ($2[0] !== canvasPropRef || $2[1] !== canvasRef || $2[2] !== selection) {
    t0 = (el) => {
      ...
      if (el === null && selection.current !== void 0) {
        var _canvasPropRef$curren;
        canvasPropRef === null || canvasPropRef === void 0 || (_canvasPropRef$curren = canvasPropRef.current) === null || _canvasPropRef$curren === void 0 || _canvasPropRef$curren.focus({
          preventScroll: true
        });
      } else {
        if (el !== null) {
    ...
    t1 = () => ({
      focus: () => {
        ...
        if (el_0 === null || !document.contains(el_0)) {
          var _canvasPropRef$curren2;
          canvasPropRef === null || canvasPropRef === void 0 || (_canvasPropRef$curren2 = canvasPropRef.current) === null || _canvasPropRef$curren2 === void 0 || _canvasPropRef$curren2.focus({
            preventScroll: true
          });
        } else {
          el_0.focus({
      ...
      getBounds: (col, row) => {
        if (canvasPropRef === void 0 || canvasPropRef.current === null) {
          return;
        }
        return getBoundsForItem(canvasPropRef.current, col !== null && col !== void 0 ? col : 0, row !== null && row !== void 0 ? row : -1);
      },
      damage,
  ...
  if ($2[10] !== accessibilityHeight || $2[11] !== canvasPropRef || $2[12] !== cellXOffset || $2[13] !== cellYOffset || $2[14] !== disableAccessibilityTree || $2[15] !== dragAndDropState || $2[16] !== firstColAccessible || $2[17] !== focusElement || $2[18] !== getBoundsForItem || $2[19] !== getCellContent || $2[20] !== getCellRenderer || $2[21] !== mappedColumns || $2[22] !== onCellFocused || $2[23] !== onKeyDown || $2[24] !== rows || $2[25] !== selection || $2[26] !== translateX || $2[27] !== width) {
    t3 = () => {
      ...
      const visibleCols = effectiveCols.map(_temp$8);
      ...
      return /* @__PURE__ */ jsxs("table", { role: "grid", "aria-rowcount": rows + 1, "aria-multiselectable": "true", "aria-colcount": mappedColumns.length + colOffset, children: [
        /* @__PURE__ */ jsx("thead", { role: "rowgroup", children: /* @__PURE__ */ jsx("tr", { role: "row", "aria-rowindex": 1, children: effectiveCols.map((c_0) => /* @__PURE__ */ jsx("th", { role: "columnheader", "aria-selected": selection.columns.hasIndex(c_0.sourceIndex), "aria-colindex": c_0.sourceIndex + 1 + colOffset, tabIndex: -1, onFocus: (e) => {
        ...
        /* @__PURE__ */ jsx("tbody", { role: "rowgroup", children: visibleRows.map((row_0) => /* @__PURE__ */ jsx("tr", { role: "row", "aria-selected": selection.rows.hasIndex(row_0), "aria-rowindex": row_0 + 2, children: effectiveCols.map((c_1) => {
          const col_0 = c_1.sourceIndex;
          const key = packColRowToNumber(col_0, row_0);
          const focused = fCol === col_0 && fRow === row_0;
          const selected = range$1 !== void 0 && col_0 >= range$1.x && col_0 < range$1.x + range$1.width && row_0 >= range$1.y && row_0 < range$1.y + range$1.height;
          const id = `glide-cell-${col_0}-${row_0}`;
          const location = [col_0, row_0];
          const cellContent = getCellContent(location, true);
          return /* @__PURE__ */ jsx("td", { role: "gridcell", "aria-colindex": col_0 + 1 + colOffset, "aria-selected": selected, "aria-readonly": isInnerOnlyCell(cellContent) || !isReadWriteCell(cellContent), id, "data-testid": id, onClick: () => {
            const canvas = canvasPropRef === null || canvasPropRef === void 0 ? void 0 : canvasPropRef.current;
            ...
            if (e_0.target === focusRef.current || ((_lastFocusedSubdomNod = lastFocusedSubdomNode.current) === null || _lastFocusedSubdomNod === void 0 ? void 0 : _lastFocusedSubdomNod[0]) === col_0 && ((_lastFocusedSubdomNod2 = lastFocusedSubdomNode.current) === null || _lastFocusedSubdomNod2 === void 0 ? void 0 : _lastFocusedSubdomNod2[1]) === row_0) {
              return;
            }
...
const DataGrid$1 = (p2, forwardedRef) => {
  ...
  const [windowEventTarget, setWindowEventTarget] = React.useState((_experimental$eventTa = experimental === null || experimental === void 0 ? void 0 : experimental.eventTarget) !== null && _experimental$eventTa !== void 0 ? _experimental$eventTa : window);
    ...
    t1 = (rect_0) => {
      ...
      if (newRect.x < 0) {
        ...
        if (typeof r === "function") {
          return async () => (await r()).map(_temp$7);
        }
        return r.map(_temp2$5);
      }
...
function _temp2$5(row_1) {
  return [{
    kind: GridCellKind.Loading,
    allowOverlay: false
  }, ...row_1];
}
function _temp$7(row_0) {
  return [{
    kind: GridCellKind.Loading,
    allowOverlay: false
  }, ...row_0];
      ...
      if (focused && target_0 !== void 0) {
        ...
        do {
          if (onPaste === void 0) {
            ...
            const rawValue_0 = (_ref2 = text !== null && text !== void 0 ? text : (_data = data) === null || _data === void 0 ? void 0 : _data.map(_temp2$4).join("	")) !== null && _ref2 !== void 0 ? _ref2 : "";
          ...
          if (onPaste === false || typeof onPaste === "function" && (onPaste === null || onPaste === void 0 ? void 0 : onPaste([target_0[0] - rowMarkerOffset, target_0[1]], data.map(_temp4$1))) !== true) {
            return;
          }
        ...
        if (gridSelection.current !== void 0) {
          ...
          if (selectedRows_0 !== void 0 && selectedRows_0.length > 0) {
            ...
            const cells_0 = toCopy.map((rowIndex) => {
              ...
              return thunk_0().then(_temp6$1);
            });
            if (cells_0.some(_temp7$1)) {
            ...
            if (selectedColumns_0.length > 0) {
              ...
              if (results.length === 1) {
                ...
                const toCopy_0 = results.reduce(_temp8$1);
...
function _temp4$1(r_1) {
  return r_1.map(_temp3$1);
}
function _temp3$1(cb_0) {
...
function _temp2$3(acc_0, group_0) {
  return acc_0 + (group_0.isCollapsed ? 1 : group_0.rows + 1);
}
function _temp$5(acc, group) {
  ...
  if ($2[0] !== appendColumnRef || $2[1] !== appendRowRef || $2[2] !== canvasRef || $2[3] !== gridRef || $2[4] !== normalSizeColumn || $2[5] !== onCopy || $2[6] !== onKeyDown || $2[7] !== onPasteInternal || $2[8] !== rowMarkerOffset || $2[9] !== scrollRef || $2[10] !== scrollToRef) {
    t0 = () => ({
      ...
      getBounds: (col_0, row_0) => {
        ...
        return (_gridRef$current2 = gridRef.current) === null || _gridRef$current2 === void 0 ? void 0 : _gridRef$current2.getBounds((col_0 !== null && col_0 !== void 0 ? col_0 : 0) + rowMarkerOffset, row_0);
      },
      focus: () => {
        var _gridRef$current3;
        return (_gridRef$current3 = gridRef.current) === null || _gridRef$current3 === void 0 ? void 0 : _gridRef$current3.focus();
      },
      emit: async (e) => {
        bb65: switch (e) {
          case "delete": {
            onKeyDown({
              bounds: void 0,
              cancel: _temp$3,
              stopPropagation: _temp2$1,
              preventDefault: _temp3,
              ctrlKey: false,
              key: "Delete",
              keyCode: 46,
              metaKey: false,
          ...
          case "fill-right": {
            onKeyDown({
              bounds: void 0,
              cancel: _temp4,
              stopPropagation: _temp5,
              preventDefault: _temp6,
              ctrlKey: true,
              key: "r",
              keyCode: 82,
              metaKey: false,
          ...
          case "fill-down": {
            onKeyDown({
              bounds: void 0,
              cancel: _temp7,
              stopPropagation: _temp8,
              preventDefault: _temp9,
              ctrlKey: true,
              key: "d",
              keyCode: 68,
              metaKey: false,
      ...
      remeasureColumns: (cols) => {
        for (const col_1 of cols) {
          normalSizeColumn(col_1 + rowMarkerOffset);
        }
      },
      getMouseArgsForPosition: (posX, posY, ev) => {
...
function useScrollTo(props) {
  ...
  return React.useCallback(function(col, row) {
...
function useAppendHandlers(args) {
  ...
  if ($2[0] !== focusCallback || $2[1] !== getCellContentRef || $2[2] !== mangledCols || $2[3] !== onRowAppended || $2[4] !== rowMarkerOffset || $2[5] !== rows || $2[6] !== rowsRef || $2[7] !== scrollToRef || $2[8] !== setCurrent) {
    t0 = async (col, t12, behavior) => {
      ...
      const appendResult = (_ref = (_onRowAppended = c === null || c === void 0 || (_c$trailingRowOptions = c.trailingRowOptions) === null || _c$trailingRowOptions === void 0 ? void 0 : _c$trailingRowOptions.onRowAppended) !== null && _onRowAppended !== void 0 ? _onRowAppended : onRowAppended) === null || _ref === void 0 ? void 0 : _ref();
      let r = void 0;
      let bottom = true;
      ...
      const doFocus = () => {
        ...
        (_scrollToRef$current = scrollToRef.current) === null || _scrollToRef$current === void 0 || _scrollToRef$current.call(scrollToRef, col - rowMarkerOffset, row, "both", 0, 20, behavior ? {
          behavior
        } : void 0);
        setCurrent({
          cell: [col, row],
        ...
        if (cell.allowOverlay && isReadWriteCell(cell) && cell.readonly !== true && openOverlay) {
          window.setTimeout(() => {
            var _focusCallback$curren;
            (_focusCallback$curren = focusCallback.current) === null || _focusCallback$curren === void 0 || _focusCallback$curren.call(focusCallback, col, row);
          }, 0);
        }
      };
      doFocus();
  ...
  if ($2[10] !== colsRef || $2[11] !== focusCallback || $2[12] !== getCellContentRef || $2[13] !== mangledCols || $2[14] !== onColumnAppended || $2[15] !== rowMarkerOffset || $2[16] !== scrollToRef || $2[17] !== setCurrent) {
    t1 = async (row_0, t22) => {
      ...
      let r_0 = void 0;
      let right = true;
      if (appendResult_0 !== void 0) {
        r_0 = await appendResult_0;
        if (r_0 === "left") {
          right = false;
        }
        if (typeof r_0 === "number") {
          right = false;
        }
      }
      let backoff_0 = 0;
      const doFocus_0 = () => {
        var _scrollToRef$current2;
        if (colsRef.current <= mangledCols.length) {
          if (backoff_0 < 500) {
            window.setTimeout(doFocus_0, backoff_0);
          }
          backoff_0 = 50 + backoff_0 * 2;
          return;
        }
        const col_0 = typeof r_0 === "number" ? r_0 : right ? mangledCols.length : 0;
        (_scrollToRef$current2 = scrollToRef.current) === null || _scrollToRef$current2 === void 0 || _scrollToRef$current2.call(scrollToRef, col_0 - rowMarkerOffset, row_0);
        setCurrent({
          cell: [col_0, row_0],
          range: {
            x: col_0,
        ...
        const cell_0 = getCellContentRef.current([col_0 - rowMarkerOffset, row_0]);
        if (cell_0.allowOverlay && isReadWriteCell(cell_0) && cell_0.readonly !== true && openOverlay_0) {
          window.setTimeout(() => {
            var _focusCallback$curren2;
            (_focusCallback$curren2 = focusCallback.current) === null || _focusCallback$curren2 === void 0 || _focusCallback$curren2.call(focusCallback, col_0, row_0);
          }, 0);
        }
      };
      doFocus_0();
  ...
  if ($2[19] !== columns || $2[20] !== columnsIn || $2[21] !== hasRowMarkers || $2[22] !== (trailingRowOptions === null || trailingRowOptions === void 0 ? void 0 : trailingRowOptions.targetColumn)) {
    t2 = (col_1) => {
      ...
      if (typeof customTargetColumn === "object") {
        ...
        if (maybeIndex >= 0) {
          const customTargetOffset_0 = hasRowMarkers ? 1 : 0;
          return maybeIndex + customTargetOffset_0;
        }
      }
    };
    $2[19] = columns;
...
function getSpanStops(cells) {
  var _cells$0$filter$flatM, _cells$;
  return (_cells$0$filter$flatM = (_cells$ = cells[0]) === null || _cells$ === void 0 ? void 0 : _cells$.filter((c) => c.span !== void 0).flatMap((c) => {
          ...
          if (x2 === -2) {
            ...
            if (x2 === 1) {
              ...
              if (x2 === -1) {
                ...
                if (right > col + 1) {
                  if (disallowed.length > 0) {
                    const target_0 = range(right - 1, col, -1).find((n_0) => !disallowed.includes(n_0 - rowMarkerOffset));
                    if (target_0 !== void 0) {
                      right = target_0;
                      done_0 = true;
                    }
  ...
  if ($2[13] !== (currentCell === null || currentCell === void 0 ? void 0 : currentCell[0]) || $2[14] !== (currentCell === null || currentCell === void 0 ? void 0 : currentCell[1]) || $2[15] !== gridSelection || $2[16] !== mangledCols.length || $2[17] !== mangledRows || $2[18] !== rowMarkerOffset || $2[19] !== scrollTo || $2[20] !== scrollToActiveCell || $2[21] !== setCurrent || $2[22] !== setGridSelection) {
    t2 = (col_0, row_0, fromEditingTrailingRow, freeMove) => {
      ...
      if (scrollToActiveCell) {
        scrollTo(col_0 - rowMarkerOffset, row_0, "both", 0, 20);
      }
      return true;
    };
...
function useFinishEditing(args) {
  const {
    gridSelection,
    mangledRows,
    mangledCols,
  ...
  return React.useCallback((newValue, movement) => {
    var _ghostInputRef$curren, _ghostInputRef$curren2, _currentOverlay$conte, _ghostInputRef$curren3, _ghostInputRef$curren4;
    const currentOverlay = overlayRef.current;
    let finalValue = newValue;
    const ghostText = (_ghostInputRef$curren = (_ghostInputRef$curren2 = ghostInputRef.current) === null || _ghostInputRef$curren2 === void 0 ? void 0 : _ghostInputRef$curren2.getValue()) !== null && _ghostInputRef$curren !== void 0 ? _ghostInputRef$curren : "";
    ...
    (_ghostInputRef$curren3 = ghostInputRef.current) === null || _ghostInputRef$curren3 === void 0 || _ghostInputRef$curren3.clear();
    (_ghostInputRef$curren4 = ghostInputRef.current) === null || _ghostInputRef$curren4 === void 0 || _ghostInputRef$curren4.setVisible(false);
    ...
    if (gridSelection.current !== void 0 && (movX !== 0 || movY !== 0)) {
      ...
      if (updateSelected) {
        ...
        window.requestAnimationFrame(() => {
          var _ghostInputRef$curren5;
          (_ghostInputRef$curren5 = ghostInputRef.current) === null || _ghostInputRef$curren5 === void 0 || _ghostInputRef$curren5.focus();
        });
      }
    }
...
function useVisibleRegionCallback(args) {
  const {
    currentCell,
    overlay,
    rowMarkerOffset,
  ...
  return React.useCallback((region, clientWidth, clientHeight, rightElWidth, tx, ty) => {
...
function useHoverHandler(args) {
  ...
  const adjustSelectionOnScroll = React.useCallback(() => {
    ...
    if (xDir === -1) {
      ...
      col_0 = (_visible$extras$freez = (_visible$extras = visible.extras) === null || _visible$extras === void 0 || (_visible$extras = _visible$extras.freezeRegion) === null || _visible$extras === void 0 ? void 0 : _visible$extras.x) !== null && _visible$extras$freez !== void 0 ? _visible$extras$freez : visible.x;
    } else if (xDir === 1) {
      col_0 = visible.x + visible.width;
    }
    if (yDir === -1) {
      row_0 = Math.max(0, visible.y);
    } else if (yDir === 1) {
      row_0 = Math.min(rows - 1, visible.y + visible.height);
    }
  ...
  return {
    onItemHoveredImpl,
    adjustSelectionOnScroll,
    hoveredRef
  };
}
function useColumnCallbacks(args) {
  const {
    rowMarkerOffset,
    columnSelect,
    onColumnProposeMove,
  ...
  const onColumnMovedImpl = whenDefined(onColumnMoved, React.useCallback((startIndex_0, endIndex_0) => {
    onColumnMoved === null || onColumnMoved === void 0 || onColumnMoved(startIndex_0 - rowMarkerOffset, endIndex_0 - rowMarkerOffset);
    if (columnSelect !== "none") {
      setSelectedColumns(CompactSelection.fromSingleSelection(endIndex_0), void 0, true);
    }
...
const DataEditorImpl = (p2, forwardedRef) => {
  var _gridSelection$curren, _gridSelection$curren2, _gridSelectionOuter$c, _gridSelectionOuter$c2;
  ...
  const {
    ...
    setOverlay,
    setOverlaySimple
  } = useOverlayEditor(mangledCols, mangledGetGroupDetails, getRowThemeOverride, mergedTheme);
  ...
  const focusCellClipLeft = React.useMemo(() => {
    if (highlightFocusCol === void 0 || highlightFocusRow === void 0) return void 0;
    const cell = getMangledCellContent([highlightFocusCol, highlightFocusRow]);
    if (cell.kind === GridCellKind.Custom) {
      const renderer = getCellRenderer(cell);
      if (renderer !== void 0 && "getContentLeftOffset" in renderer) {
        return renderer.getContentLeftOffset(cell, mergedTheme);
      }
    }
    return void 0;
  ...
  }, [fillHighlightRegion, focusCellClipLeft, highlightRange, highlightFocusCol, highlightFocusRow, highlightRegionsIn, mangledCols.length, mergedTheme.accentColor, rowMarkerOffset]);
  ...
  React.useEffect(() => {
    ...
    const handleParentScroll = (event) => {
      ...
      if (scrollRef.current && !scrollRef.current.contains(target)) {
        var _target$closest;
        if ((_target$closest = target.closest) !== null && _target$closest !== void 0 && _target$closest.call(target, ".gdg-clip-region")) return;
        setOverlay(void 0);
      }
    };
  ...
  const currentCell = gridSelection === null || gridSelection === void 0 || (_gridSelection$curren2 = gridSelection.current) === null || _gridSelection$curren2 === void 0 ? void 0 : _gridSelection$curren2.cell;
