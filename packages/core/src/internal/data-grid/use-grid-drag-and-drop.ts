...
export function useGridDragAndDrop(args: GridDragAndDropArgs): void {
    ...
    useEventListener("dragstart", onDragStartImpl, eventTargetRef ?? null, false, false);
    ...
    useEventListener("dragover", onDragOverImpl, eventTargetRef ?? null, false, false);

    const onDragEndImpl = () => {
        activeDropTarget.current = undefined;
        onDragEnd?.();
    };
    useEventListener("dragend", onDragEndImpl, eventTargetRef ?? null, false, false);
    ...
    useEventListener("drop", onDropImpl, eventTargetRef ?? null, false, false);

    const onDragLeaveImpl = () => {
        onDragLeave?.();
    };
    useEventListener("dragleave", onDragLeaveImpl, eventTargetRef ?? null, false, false);
}
