/**
 * Type definitions for DataEditor component.
 * Extracted from data-editor.tsx for better maintainability.
 * @module
 */
import type {
    EditableGridCell,
...
export type EmitEvents = "copy" | "paste" | "delete" | "fill-right" | "fill-down";
