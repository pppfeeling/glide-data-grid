...
export function useGhostInput(args: UseGhostInputArgs): GhostInputHandlers {
    ...
    const onGhostInput = React.useCallback(
        ...
        [gridSelection, getMangledCellContent, rowMarkerOffset, onCellActivated, reselect, gridRef, overlayRef]
    );
    ...
    }, [gridSelection, getMangledCellContent, rowMarkerOffset, onCellActivated, reselect, ghostInputRef, gridRef, overlayRef, state]);
    ...
    const onGhostKeyDown = React.useCallback(
        ...
        [gridSelection, onKeyDown, onFinishEditing, getMangledCellContent, overlayRef, ghostInputVisibleRef, gridRef]
    );
    ...
    const onGhostKeyUp = React.useCallback(
        ...
        [gridSelection, onKeyUpIn, gridRef]
    );
