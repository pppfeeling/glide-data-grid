import{R as o}from"./iframe-DDTcUdjc.js";import{D as Y}from"./data-editor-all-DTNR_ELW.js";import{C as b,G as m,i as T}from"./image-window-loader-Ba2dfKLx.js";import{B as Z,D as ee,u as te,d as ae}from"./utils-BMaH_XUh.js";import{S as ne}from"./story-utils-tSAhB5KM.js";import"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./throttle-C2-49NaF.js";import"./flatten-BavRFQMS.js";import"./scrolling-data-grid-CqIwtj2o.js";import"./marked.esm-jmFFBRfF.js";import"./throttle--dN168Gr.js";const ge={title:"Glide-Data-Grid/DataEditor Demos",decorators:[g=>o.createElement(ne,null,o.createElement(Z,{title:"Add data",description:o.createElement(o.Fragment,null,o.createElement(ee,null,"rowSelection 관련 prop : rowSelec(single, multi), rowSelectionMode - (rowSelect가 multi일때 선택방법), rowMarker (모양설정),",o.createElement("br",null),"rowSelection 제어 prop :gridSelection, onGridSelectionChange"))},o.createElement(g,null)))]},f=[{title:"First name",id:"First name"},{title:"Last name",id:"Last name"},{title:"Avatar",id:"Avatar"},{title:"Email",id:"Email"},{title:"Title",id:"Title"},{title:"More Info",id:"More Info"},{title:"Date",id:"Date",width:200}],I=["John","Jane","Bob","Alice","Charlie","Diana","Evan","Fiona","George","Hannah"],k=["Doe","Smith","Johnson","Brown","Williams","Jones","Miller","Davis","Garcia","Rodriguez"],oe=(g,u=0)=>{switch(g){case 0:return{kind:m.Text,displayData:I[u%I.length],data:I[u%I.length],allowOverlay:!0,readonly:!1};case 1:return{kind:m.Text,displayData:k[u%k.length],data:k[u%k.length],allowOverlay:!0,readonly:!1};case 2:return{kind:m.Number,displayData:(1e3+u*100).toLocaleString(),data:1e3+u*100,allowOverlay:!0,readonly:!1,contentAlign:"right"};default:return{kind:m.Text,displayData:"2024-01-01",data:"2024-01-01",allowOverlay:!0,readonly:!1,contentAlign:"center"}}},v=(g,u=0)=>g.map((x,R)=>oe(R,u)),D=()=>{const g=o.useRef(null),[u,x]=o.useState({columns:b.empty(),rows:b.empty()});te(4);const R=100,[p,C]=o.useState(()=>{const n=[];for(let e=0;e<R;e++)n.push(v(f,e));return n}),[j,V]=o.useState(R),[G,N]=o.useState(new Set),[O,y]=o.useState(new Map),[F,B]=o.useState(()=>{const n=new Map;for(let e=0;e<R;e++)n.set(e,`ROW-${String(e+1).padStart(4,"0")}`);return n}),S=o.useCallback(n=>{var t,r;const e=(t=p[n])==null?void 0:t[0],l=(r=p[n])==null?void 0:r[3];e&&"data"in e&&e.data;const i=l&&"data"in l?l.data+"":"";i!=null&&i.includes("gmail")?N(s=>new Set(s).add(n)):N(s=>{const a=new Set(s);return a.delete(n),a})},[p]),E=o.useCallback(([n,e])=>{var i;const l=(i=p[e])==null?void 0:i[n];return l===void 0?{kind:m.Text,displayData:"",data:"",allowOverlay:!0,readonly:!1}:G.has(e)?{...l,themeOverride:{bgCell:"#fff2b2"}}:l},[p,G]),K=o.useCallback(([n,e],l)=>{C(i=>{const t=[...i],r=[...t[e]||[]];return r[n]=l,t[e]=r,t}),y(i=>{const t=new Map(i);return t.get(e)!=="A"&&t.set(e,"U"),t}),S(e)},[S]),L=o.useCallback(n=>{const{patternSource:e,fillDestination:l}=n,i=[];for(let r=0;r<e.height;r++){const s=[];for(let a=0;a<e.width;a++)s.push(E([e.x+a,e.y+r]));i.push(s)}const t=new Set;C(r=>{const s=[...r];for(let a=0;a<l.height;a++){const d=l.y+a;s[d]||(s[d]=v(f,d));const c=[...s[d]];for(let w=0;w<l.width;w++){const h=i[a%e.height][w%e.width],A=l.x+w;T(h)&&(c[A]=h,t.add(d))}s[d]=c}return s}),t.forEach(r=>S(r))},[f,E,S]),$=o.useCallback((n,e)=>{const[l,i]=n,t=new Set;return C(r=>{const s=[...r];return e.forEach((a,d)=>{const c=i+d;s[c]||(s[c]=v(f,c));const w=[...s[c]];a.forEach((h,A)=>{const M=l+A;if(M<f.length){const W=w[M];if(T(W)){const X={...W,data:h};w[M]=X,t.add(c)}}}),s[c]=w}),s}),t.forEach(r=>S(r)),!1},[f.length,f,S]),_=o.useCallback(()=>{C(n=>{const e=[...n],l=v(f,e.length),i=u.rows.first();let t;return i!==void 0?(t=i+1,e.splice(t,0,l)):(t=e.length,e.push(l)),y(r=>{const s=new Map(r);if(i!==void 0){const a=new Map;return r.forEach((d,c)=>{c>=t?a.set(c+1,d):a.set(c,d)}),a.set(t,"A"),a}else return s.set(t,"A"),s}),B(r=>{const s=new Map(r),a=Math.max(0,...[...r.values()].map(c=>{const w=c.match(/ROW-(\d+)/);return w?parseInt(w[1]):0})),d=`ROW-${String(a+1).padStart(4,"0")}`;if(i!==void 0){const c=new Map;return r.forEach((w,h)=>{h>=t?c.set(h+1,w):c.set(h,w)}),c.set(t,d),c}else return s.set(t,d),s}),V(e.length),e})},[f,u.rows]),q=o.useCallback(()=>{u.rows.length!==0&&(y(n=>{const e=new Map(n);return u.rows.toArray().forEach(l=>{n.get(l)==="A"?e.delete(l):e.set(l,"D")}),e}),x({columns:b.empty(),rows:b.empty()}))},[u.rows]),z=o.useCallback(()=>{if(p.length===0)return;const n=f.map(s=>s.title).join(","),e=p.map(s=>s.map(a=>{var w,h;let d="";return a.kind===m.Text||a.kind===m.Number?d=a.displayData??((w=a.data)==null?void 0:w.toString())??"":a.kind===m.Image||a.kind===m.Drilldown||a.kind===m.Bubble?d=Array.isArray(a.data)?a.data.join(";"):"":a.kind===m.Boolean&&(d=((h=a.data)==null?void 0:h.toString())??"false"),`"${d.replace(/"/g,'""')}"`}).join(",")),l="\uFEFF"+[n,...e].join(`
`),i=new Blob([l],{type:"text/csv;charset=utf-8;"}),t=document.createElement("a"),r=URL.createObjectURL(i);t.setAttribute("href",r),t.setAttribute("download","grid-data.csv"),t.style.visibility="hidden",document.body.append(t),t.click(),t.remove()},[p,f]),J=o.useCallback(n=>O.get(n),[O]),Q=o.useCallback(n=>F.get(n),[F]);return o.createElement(o.Fragment,null,o.createElement("div",null,o.createElement("button",{onClick:_},"열추가"),o.createElement("button",{onClick:q},"열삭제"),o.createElement("button",{onClick:z},"CSV다운로드")),o.createElement(Y,{...ae,width:"100%",height:"500px",ref:g,columns:f,rows:j,getCellContent:E,isActivationOnEnter:!0,rowSelect:"multi",rowSelectionMode:"multi",rowMarkers:{kind:"checkbox-visible",checkboxStyle:"square",headerAlwaysVisible:!0,headerDisabled:!1,headerTheme:{textMedium:"rgba(51, 51, 51, 0.50)"},rowNumber:!0,rowStatus:!0,rowStatusWidth:40,rowStatusTheme:{bgCell:"#f5f5f5",textDark:"#333"},rowId:!0,rowIdWidth:100,rowIdTheme:{bgCell:"#f0f8ff",textDark:"#0066cc"}},fillHandle:{size:6},onCellEdited:(n,e)=>{K(n,e)},onFillPattern:L,onPaste:$,onGridSelectionChange:x,gridSelection:u,onRowStatus:J,onRowId:Q}))};D.storyName="06. Add Data";var H,P,U;D.parameters={...D.parameters,docs:{...(H=D.parameters)==null?void 0:H.docs,source:{originalSource:`() => {
...
}`,...(U=(P=D.parameters)==null?void 0:P.docs)==null?void 0:U.source}}};const Se=["AddData"];export{D as AddData,Se as __namedExportsOrder,ge as default};
