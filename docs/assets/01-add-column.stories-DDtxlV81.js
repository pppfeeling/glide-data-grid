import{R as e}from"./iframe-D4vZ5rhH.js";import{D as I}from"./data-editor-all-DL7jiolZ.js";import{B as S,D,M as y,u as E,d as H}from"./utils-vwsr7a_8.js";import{S as O}from"./story-utils-CjSYydda.js";import{u as z}from"./image-window-loader-CbPlwf3M.js";import"./preload-helper-C1FmrZbK.js";import"./throttle-Cv1ZfGkn.js";import"./flatten-B1NF2nwu.js";import"./scrolling-data-grid-CRvnlqUn.js";import"./marked.esm--zAVFZ8e.js";import"./index-D_kXk1yT.js";import"./throttle--dN168Gr.js";const{fn:w}=__STORYBOOK_MODULE_TEST__,j={title:"Glide-Data-Grid/DataEditor Demos",decorators:[s=>e.createElement(O,null,e.createElement(S,{title:"Add and remove columns",description:e.createElement(e.Fragment,null,e.createElement(D,null,"You can add and remove columns at your disposal"),e.createElement(y,null,"Use the story's controls to change the number of columns 컬럼추가삭제, 컬럼고정, 컬럼리사이즈, 컬러정의"))},e.createElement(s,null)))]},r=s=>{const a=z(),{cols:i,getCellContent:m}=E(s.columnsCount),[d,C]=e.useState(()=>i.map((n,t)=>({...n}))),h=e.useCallback((n,t)=>{C(l=>{const o=l.findIndex(R=>R.title===n.title),c=[...l];return c.splice(o,1,{...l[o],width:t}),c})},[]),[p,u]=e.useState(null),k=e.useCallback((n,t)=>{C(l=>{const o=[...l],[c]=o.splice(n,1);return o.splice(t,0,c),o}),u(t)},[]),x=e.useCallback(n=>{const[t,l]=n,o=i.findIndex(c=>c.title===d[t].title);return m([o,l])},[i,m,d]),b=e.useCallback(n=>{u(n)},[]),M=e.useCallback(n=>{u(null),s.onCellClicked(n)},[s]),A=e.useMemo(()=>d.map((n,t)=>{const{themeOverride:l,...o}=n;return t===p?{...o,themeOverride:{bgHeader:a.accentColor,bgHeaderHovered:a.accentColor,textHeader:a.accentFg},indicatorIcon:"headerArrowDown"}:{...o,themeOverride:void 0,indicatorIcon:"headerArrowDown"}}),[d,p,a]);return e.createElement(I,{...H,rowMarkers:"number",getCellContent:x,rows:200,freezeColumns:1,columns:A,onColumnResize:h,onColumnMoved:k,onHeaderClicked:b,onCellClicked:M,onCellActivated:s.onCellActivated,freezeTrailingRows:1})};r.storyName="01. Column";r.args={columnsCount:10,onCellClicked:w(),onCellActivated:w()};r.argTypes={columnsCount:{control:{type:"range",min:2,max:200}}};var g,v,f;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`(p: AddColumnsProps) => {
