import{r as i}from"./iframe-DfFb5Ign.js";import{B as Ye}from"./story-utils-DlkJV70N.js";import{C as g,G as a}from"./image-window-loader-DuEXGL_L.js";import{D as d}from"./data-editor-all-C-BnK6SF.js";import"./preload-helper-C1FmrZbK.js";import"./marked.esm-CIUALPyN.js";import"./throttle-ByAiyUNP.js";import"./index-KG-dsUoR.js";import"./flatten-By6_WT6j.js";import"./scrolling-data-grid-DuhwYF3j.js";const{useState:c,useCallback:m,useMemo:h}=__STORYBOOK_MODULE_PREVIEW_API__,ot={title:"Tests/TestCases",decorators:[e=>i.createElement(Ye,{width:1e3,height:800},i.createElement(e,null))]};function w([e,t]){return e===0?{kind:a.RowID,data:`RowID ${e}, ${t}`,allowOverlay:!1}:e===1?{kind:a.Bubble,data:[`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`,`Bub ${e}`,`Bub ${t}`],allowOverlay:!0}:e===2?{kind:a.Image,data:["https://i.imgur.com/5J0BftG.jpg","https://preview.redd.it/7jlqkp2cyap51.jpg?width=575&auto=webp&s=26fa9ed15b16fb450ee08ed1f2f0ccb5e0223581"],allowOverlay:!0,readonly:!1}:e===3?{kind:a.Markdown,data:`## Markdown has titles
