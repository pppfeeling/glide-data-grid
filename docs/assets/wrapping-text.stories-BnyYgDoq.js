import{R as e}from"./iframe-DB4XqYnF.js";import{D as f}from"./data-editor-all-DxD1qKN2.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-B2bhh9kE.js";import{G as y}from"./image-window-loader-Ce11dqI5.js";import{S as W}from"./story-utils-pxLbAniP.js";import{r as D}from"./throttle-BB6hEv_h.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./index-DlpFMiw3.js";import"./flatten-Hif-LLO8.js";import"./scrolling-data-grid-BuDRV0BM.js";import"./marked.esm-B2lddrDO.js";import"./throttle--dN168Gr.js";const _={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:a,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(l=>{const[u,o]=l;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${o},
${r[o%r.length]}`,data:`${o}, 
