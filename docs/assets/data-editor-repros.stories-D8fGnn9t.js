import{r as t}from"./iframe-C1adrrhA.js";import{B as w}from"./story-utils-Bv0N71rq.js";import{G as h}from"./image-window-loader-CSosr3OK.js";import{D as p}from"./data-editor-all-gJeFUSLn.js";import{s as f}from"./marked.esm-BsrRDEkT.js";import"./preload-helper-C1FmrZbK.js";import"./throttle-BbvBCwfb.js";import"./index-BXP72RLD.js";import"./flatten-B9xqSffn.js";import"./scrolling-data-grid-CAQLaDn6.js";const{useState:E,useMemo:T}=__STORYBOOK_MODULE_PREVIEW_API__,M={title:"Tests/TestCases/Bugs",decorators:[e=>t.createElement(w,{width:1e3,height:800},t.createElement(e,null))]},S=([,e])=>({allowOverlay:!0,kind:h.Number,data:e,displayData:e.toString()}),A=()=>{},x=f("div")({name:"Bug70Style",class:"brdsci0",propsAsIs:!1});function n(){const e=[{title:"Col1",width:100},{title:"Col2",width:100}];return t.createElement(x,{className:"App"},t.createElement("p",null,"To cause error: scroll down at least one row, edit a cell in Col2, and hit Tab"),t.createElement("a",{href:"https://github.com/glideapps/glide-data-grid/issues/70",target:"_blank",rel:"noreferrer"},"Original report"),t.createElement(p,{width:500,height:500,rows:100,columns:e,getCellContent:S,onCellEdited:A}))}const _=([e,r])=>({allowOverlay:!0,kind:h.Text,data:`${e} - ${r}`,displayData:`${e} - ${r}`}),s=[{title:"Col AAAA",width:120},{title:"Col AAA",width:120},{title:"Col AA",width:120},{title:"Col A",width:120},{title:"Col",width:120}];function o(){const[e,r]=E(""),g=T(()=>e===""?s:s.filter(l=>l.title.toLowerCase().includes(e.toLowerCase())),[e]),C=l=>{r(l.target.value)};return t.createElement("div",null,t.createElement("input",{value:e,onChange:C}),t.createElement(p,{width:1e3,height:500,rows:100,columns:g,getCellContent:_,smoothScrollX:!0,smoothScrollY:!0}))}var a,i,c;n.parameters={...n.parameters,docs:{...(a=n.parameters)==null?void 0:a.docs,source:{originalSource:`function Bug70() {
  const cols = [{
    title: "Col1",
    width: 100
  }, {
...
}`,...(m=(d=o.parameters)==null?void 0:d.docs)==null?void 0:m.source}}};const R=["Bug70","FilterColumns"];export{n as Bug70,o as FilterColumns,R as __namedExportsOrder,M as default};
