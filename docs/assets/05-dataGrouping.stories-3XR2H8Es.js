import{R as t}from"./iframe-DB4XqYnF.js";import{D as K}from"./data-editor-all-DxD1qKN2.js";import{i as B,G as u}from"./image-window-loader-Ce11dqI5.js";import{b as A,c as $,M as j,d as P}from"./utils-B2bhh9kE.js";import{S as _}from"./story-utils-pxLbAniP.js";import{u as H}from"./useGridDataProcessing-BJjMJGs0.js";import"./preload-helper-C1FmrZbK.js";import"./index-DlpFMiw3.js";import"./throttle-BB6hEv_h.js";import"./flatten-Hif-LLO8.js";import"./scrolling-data-grid-BuDRV0BM.js";import"./marked.esm-B2lddrDO.js";import"./index-D_kXk1yT.js";import"./throttle--dN168Gr.js";const it={title:"Glide-Data-Grid/DataEditor Demos",decorators:[i=>t.createElement(_,null,t.createElement(i,null))]},g=()=>{const{cols:i,getCellContent:m,rows:v}=A(),D=t.useMemo(()=>{var o;const e=[];for(let n=0;n<v;n++){const l={originalIndex:n};for(let a=0;a<i.length;a++){const r=i[a].id??i[a].title,s=m([a,n]);if(B(s))switch(s.kind){case u.Number:case u.Text:case u.Uri:case u.Markdown:l[r]=s.data;break;case u.Boolean:l[r]=(o=s.data)==null?void 0:o.toString();break;default:l[r]=s.copyData}}e.push(l)}return e},[i,m,v]),[C,I]=t.useState(()=>new Map),[f,k]=t.useState([]),[S,G]=t.useState([]),[w,O]=t.useState(!1),d=(e,o,n)=>{I(l=>{const a=new Map(l),r=a.get(e)||{};return a.set(e,{...r,[o]:n}),a})},{filterConfig:T,groupingFunctions:M,groupingLabels:R}=t.useMemo(()=>{const e=[],o=new Map,n=new Map;C.forEach((a,r)=>{a.filterValue&&e.push({key:r,operator:a.filterOperator??"Contain",value:a.filterValue,condition:a.filterCondition??"AND"}),a.groupingLabel&&o.set(r,a.groupingLabel),a.groupingFunction&&n.set(r,a.groupingFunction)});const l={filterConfig:{filterOptions:e},groupingFunctions:n,groupingLabels:o};return console.log("[SearchDataEditor] Derived Configs:",l),l},[C]),{processedData:h,totalSummaryRow:y}=H(D,{filterConfig:T,sortState:f,groupingState:S,groupingFunctions:M,groupingLabels:R,showTotals:w,cols:i}),p=t.useMemo(()=>y?[...h,y]:h,[h,y]),L=e=>{k(o=>{const n=o.findIndex(a=>a.key===e),l=[...o];if(n!==-1){const a=l[n];a.order==="asc"?a.order="desc":l.splice(n,1)}else l.push({key:e,order:"asc"});return l})},W=e=>{G(o=>{const n=[...o],l=n.indexOf(e);return l!==-1?n.splice(l,1):n.push(e),n})},N=e=>{const o=S.indexOf(e);return o===-1?"그룹핑":`그룹핑 (${o+1})`},V=e=>{const o=f.findIndex(s=>s.key===e);if(o===-1)return"정렬";const l=f[o].order==="asc"?"오름차순":"내림차순",a=o+1,r=f.length>1?`(${a})`:"";return`${l} ${r}`.trim()},F=t.useCallback(([e,o])=>{const n=p[o];if(!n)return{kind:u.Text,data:"",displayData:"",allowOverlay:!1};const l=i[e],a=l.id??l.title;if(n.isTotalSummary){const c=n[a];return{kind:u.Text,data:c!==void 0?String(c):"",displayData:c!==void 0?String(c):"",allowOverlay:!1,readonly:!0,themeOverride:{bgCell:"#f7f7f7",textDark:"#000000",bgCellMedium:"#f0f0f0"}}}if(n.isGroupSummary){const c=n[a];return c!==void 0?{kind:u.Text,data:String(c),displayData:String(c),allowOverlay:!1,readonly:!0,themeOverride:{bgCell:"#e0e0e0"}}:{kind:u.Text,data:"",displayData:"",allowOverlay:!1,readonly:!0,themeOverride:{bgCell:"#e0e0e0"}}}const r=n.originalIndex;return r!==void 0?m([e,r]):{kind:u.Text,data:"Error",displayData:"Error",allowOverlay:!1}},[i,m,p,S]),q=t.useCallback(e=>{const o=p[e];if(o&&o.isGroupSummary)return{bgCell:"#e0e0e0"};if(o&&o.isTotalSummary)return{bgCell:"#f7f7f7",bgCellMedium:"#f0f0f0"}},[p]);return t.createElement($,{title:"Sort, filter, grouping",height:"400px",description:t.createElement(t.Fragment,null,t.createElement("div",null,t.createElement("input",{type:"checkbox",checked:w,onChange:e=>O(e.target.checked)}),"총 합계 보이기 (제일 마지막열)"),t.createElement("table",null,t.createElement("thead",null,t.createElement("tr",null,t.createElement("td",null,"컬럼명"),t.createElement("td",null,"조건"),t.createElement("td",null,"연산자"),t.createElement("td",null,"값"),t.createElement("td",null,"정렬"),t.createElement("td",null,"필터링"),t.createElement("td",null,"그룹핑"),t.createElement("td",null,"그룹핑 레이블"),t.createElement("td",null,"그룹핑 함수"))),t.createElement("tbody",null,i.map(e=>{const o=C.get(e.title)||{};return t.createElement("tr",{key:e.id??e.title},t.createElement("td",null,e.title),t.createElement("td",null,t.createElement("select",{value:o.filterCondition??"AND",onChange:n=>d(e.title,"filterCondition",n.target.value)},t.createElement("option",{value:"AND"},"AND"),t.createElement("option",{value:"OR"},"OR"))),t.createElement("td",null,t.createElement("select",{value:o.filterOperator??"Contain",onChange:n=>d(e.title,"filterOperator",n.target.value)},t.createElement("option",{value:"Contain"},"Contain"),t.createElement("option",{value:"Not Contain"},"Not Contain"),t.createElement("option",{value:"Equals"},"Equals"),t.createElement("option",{value:"NotEqual"},"NotEqual"),t.createElement("option",{value:"StartWith"},"StartWith"),t.createElement("option",{value:"EndWith"},"EndWith"),t.createElement("option",{value:"Great"},"Great"),t.createElement("option",{value:"GreatWithEqual"},"GreatWithEqual"),t.createElement("option",{value:"Less"},"Less"),t.createElement("option",{value:"LessWithEqual"},"LessWithEqual"),t.createElement("option",{value:"Between"},"Between"))),t.createElement("td",null,t.createElement("input",{type:"text",value:o.filterValue??"",onChange:n=>d(e.title,"filterValue",n.target.value)})),t.createElement("td",null,t.createElement("button",{onClick:()=>L(e.title)},V(e.title))),t.createElement("td",null,t.createElement("button",{onClick:()=>{}},"필터링")),t.createElement("td",null,t.createElement("button",{onClick:()=>W(e.title)},N(e.title))),t.createElement("td",null,t.createElement("input",{type:"text",placeholder:"그룹 레이블",value:o.groupingLabel??"",onChange:n=>d(e.title,"groupingLabel",n.target.value)})),t.createElement("td",null,t.createElement("select",{value:o.groupingFunction??"",onChange:n=>d(e.title,"groupingFunction",n.target.value)},t.createElement("option",{value:""},"없음"),t.createElement("option",{value:"label"},"label"),t.createElement("option",{value:"sum"},"Sum"),t.createElement("option",{value:"count"},"Count"),t.createElement("option",{value:"avg"},"Avg"),t.createElement("option",{value:"min"},"Min"),t.createElement("option",{value:"max"},"Max"))))}))),t.createElement(j,null))},t.createElement(K,{...P,height:"100%",getCellContent:F,columns:i,rows:p.length,getRowThemeOverride:q,freezeTrailingRows:1}))};g.storyName="05. Sort, filter, grouping";var E,x,b;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`() => {
  const {
    cols,
    getCellContent,
    rows
  ...
  const {
    ...
    const derivedConfigs = {
      ...
      groupingFunctions: functionsMap,
      groupingLabels: labelsMap
    };
  ...
  return <BeautifulWrapperHeight title="Sort, filter, grouping" height={"400px"} description={<>
          ...
          return <tr key={col.id ?? col.title}>
                                        <td>{col.title}</td>
                                        <td>
...
}`,...(b=(x=g.parameters)==null?void 0:x.docs)==null?void 0:b.source}}};const ut=["SearchDataEditor"];export{g as SearchDataEditor,ut as __namedExportsOrder,it as default};
