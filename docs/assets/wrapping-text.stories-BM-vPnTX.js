import{R as e}from"./iframe-WMPUn1pL.js";import{D as f}from"./data-editor-all-G-wcXuTe.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-5yjwV-T1.js";import{G as y}from"./image-window-loader-DJOs-Z_J.js";import{S as W}from"./story-utils-nqnjxCk5.js";import{r as D}from"./throttle-Bd7MXYl9.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./index-VmO6qoem.js";import"./flatten-CfNc2yDy.js";import"./scrolling-data-grid-DQxfRL_g.js";import"./marked.esm-09Xzqy-J.js";import"./throttle--dN168Gr.js";const _={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:a,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(l=>{const[u,o]=l;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${o},
${r[o%r.length]}`,data:`${o}, 
