import{R as e}from"./iframe-BRH0sI4T.js";import{D as f}from"./data-editor-all-Cmfpg6eG.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-CcTSkric.js";import{G as y}from"./image-window-loader-C07KUb0y.js";import{S as W}from"./story-utils-Cr9WLRtl.js";import{r as D}from"./throttle-CLO2z2b9.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./index-CNdQ_i0E.js";import"./flatten-DLKYwgY1.js";import"./scrolling-data-grid-DdPqTsp-.js";import"./marked.esm-C8Dy4b6m.js";import"./throttle--dN168Gr.js";const _={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:a,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(l=>{const[u,o]=l;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${o},
${r[o%r.length]}`,data:`${o}, 
