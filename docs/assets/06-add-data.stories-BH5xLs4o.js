...
`),i=new Blob([l],{type:"text/csv;charset=utf-8;"}),t=document.createElement("a"),s=URL.createObjectURL(i);t.setAttribute("href",s),t.setAttribute("download","grid-data.csv"),t.style.visibility="hidden",document.body.appendChild(t),t.click(),document.body.removeChild(t)},[p,f]),J=o.useCallback(n=>O.get(n),[O]),Q=o.useCallback(n=>F.get(n),[F]);return o.createElement(o.Fragment,null,o.createElement("div",null,o.createElement("button",{onClick:_},"열추가"),o.createElement("button",{onClick:q},"열삭제"),o.createElement("button",{onClick:z},"CSV다운로드")),o.createElement(Y,{...ae,width:"100%",height:"500px",ref:g,columns:f,rows:j,getCellContent:E,isActivationOnEnter:!0,rowSelect:"multi",rowSelectionMode:"multi",rowMarkers:{kind:"checkbox-visible",checkboxStyle:"square",headerAlwaysVisible:!0,headerDisabled:!1,headerTheme:{textMedium:"rgba(51, 51, 51, 0.50)"},rowNumber:!0,rowStatus:!0,rowStatusWidth:40,rowStatusTheme:{bgCell:"#f5f5f5",textDark:"#333"},rowId:!0,rowIdWidth:100,rowIdTheme:{bgCell:"#f0f8ff",textDark:"#0066cc"}},fillHandle:{size:6},onCellEdited:(n,e)=>{K(n,e)},onFillPattern:L,onPaste:$,onGridSelectionChange:x,gridSelection:u,onRowStatus:J,onRowId:Q}))};C.storyName="06. Add Data";var H,P,U;C.parameters={...C.parameters,docs:{...(H=C.parameters)==null?void 0:H.docs,source:{originalSource:`() => {
  ...
  return <>
            ...
            <DataEditor {...defaultProps} width="100%" height="500px" ref={gridRef} columns={cols} rows={numRows} getCellContent={getCellContentWithHighlight} isActivationOnEnter={true} rowSelect="multi" rowSelectionMode="multi" rowMarkers={{
...
}`,...(U=(P=C.parameters)==null?void 0:P.docs)==null?void 0:U.source}}};const Se=["AddData"];export{C as AddData,Se as __namedExportsOrder,ge as default};
